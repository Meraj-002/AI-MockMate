...
function Feedback({ params }) {
    ...
    return (
        ...
        <h2 className='text-3xl font-bold text-green-500'>Congratulation!</h2>
            ...
            <h2 className='tet-lg my-3 text-blue-500'> Your overall interview rating: <strong>7/10</strong></h2>

            <h2 className='tet-sm text-gray-500'>Find below interview question with correct answer, Your answer and feedback for improvement </h2>
                ...
                <Collapsible key={index} className='mt-7'>
                    ...
                    <CollapsibleContent>
                        <div className='flex flex-col gap-2'>
                            ...
                            <h2 className='p-2 border rounded-lg text-sm  bg-blue-50 text-blue-600'><strong>Feedback: </strong>{item.feedback}</h2>                       
